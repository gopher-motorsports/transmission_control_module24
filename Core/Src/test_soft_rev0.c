...
uint8_t transmission_side_output_arr[] = {upshift_state, downshift_state, fast_clutch_state, slow_clutch_state, drs_state, extra_state};
//car side output
...
void test_all_loop(void){
	...
	HAL_GPIO_WritePin(AUX2_C_PASS_OUT_GPIO_Port, AUX2_C_PASS_OUT_Pin, aux2_c_pass_state);
